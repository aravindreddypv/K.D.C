...
public class prob1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_prob1, container, false);
        ...
        r1.setText(ques_req.opn1[0]);
        r2.setText(ques_req.opn2[0]);
        r3.setText(ques_req.opn3[0]);
        r4.setText(ques_req.opn4[0]);

        question.setText(ques_req.question[0]);
        return  view;
    }
