...
public class prob3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_prob3, container, false);
        question= (TextView) view.findViewById(R.id.aa);
        question.setText(ques_req.question[2]);
        ...
        r1.setText(ques_req.opn1[2]);
        r2.setText(ques_req.opn2[2]);
        r3.setText(ques_req.opn3[2]);
        r4.setText(ques_req.opn4[2]);
